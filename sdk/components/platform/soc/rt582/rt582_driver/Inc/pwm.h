 ...
 */
#define PWM_FILL_SAMPLE_DATA_MODE0(val0, val1, val2)                           \
    ((val0 << 31) | (val2 << 16) | (val0 << 15) | (val1))
#define PWM_FILL_SAMPLE_DATA_MODE1(val0, val1, val2)                           \
    ((val2 << 16) | (val0 << 15) | (val1))
