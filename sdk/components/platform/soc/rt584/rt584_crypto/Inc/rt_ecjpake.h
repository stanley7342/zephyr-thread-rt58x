 ...
 */
 ...
 /**
 * \file           rt_ecjpake.h
 * \brief          ECJPAKE HERE only support SECP256R1.. so each ECC key must be 64 bytes.
 */
#ifndef _RT584_ECJPAKE_ECC256_H_
#define _RT584_ECJPAKE_ECC256_H_
...
/**
 * \brief           In IETF document, this is ECSchnorrZKP struct
 */
typedef struct {
...
/**
 * \brief           ECJPAKE structure
 * \details         This is very large structure... so please use this struct in heap... and
...
/*@}*/ /* end of RT584_DRIVER ECJPAKE */

#ifdef __cplusplus
}
#endif

#endif /* End of _RT584_ECJPAKE_ECC256_H_ */
