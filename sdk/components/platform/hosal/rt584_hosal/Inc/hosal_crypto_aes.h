...
typedef enum {
    ...
    HOSAL_AES_CMAC_LOAD_MAC_KEY = 3,  /*!< AES operation for encryption   */
    HOSAL_AES_CMAC_CBC = 4,           /*!< AES operation for encryption   */
...
/*@}*/ /* end of RT584_HOSAL HOSAL_CRYPTO_AES */
