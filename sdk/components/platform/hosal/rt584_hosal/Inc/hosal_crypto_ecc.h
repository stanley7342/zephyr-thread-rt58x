...
#define HOSAL_ECC_CURVE_SM2P192_INIT        6
#define HOSAL_ECC_CURVE_SM2P256_INIT        7

/**
 * \brief           hosal crypto ecc p256 enum defined
 */
typedef  enum {
    HOSAL_ECDA_P256_SIGNATURE = 1,
    HOSAL_ECC_SM2P256_SIGNATURE = 2,
    HOSAL_ECDA_P256_VERIFY = 3,
    HOSAL_ECDA_SM2P256_VERIFY = 4,
    HOSAL_GFP_P256_MULTI = 5,
    HOSAL_GFP_P256_VAILD_VERIFY =6,
    HOSAL_GFP_P256_ADD = 7,
    HOSAL_GFP_P256_MOD_MULTI = 8,
    HOSAL_GFP_P192_MULTI = 9,
    HOSAL_GFP_B163_MULTI = 10,
...
/*@}*/ /* end of RT584_HOSAL HOSAL_CRYPTO_ECC */
