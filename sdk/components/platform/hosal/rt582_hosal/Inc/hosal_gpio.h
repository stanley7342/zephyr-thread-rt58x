 ...
 */
#define HOSAL_GPIO_PIN_NOINT            GPIO_PIN_NOINT              /*!< GPIO Interrupt mode disable */
#define HOSAL_GPIO_PIN_INT_LEVEL_LOW    GPIO_PIN_INT_LEVEL_LOW      /*!< GPIO Interrupt enable for Level-Low */
#define HOSAL_GPIO_PIN_INT_LEVEL_HIGH   GPIO_PIN_INT_LEVEL_HIGH     /*!< GPIO Interrupt enable for Level-High */
#define HOSAL_GPIO_PIN_INT_EDGE_RISING  GPIO_PIN_INT_EDGE_RISING    /*!< GPIO Interrupt enable for Rising Edge */
#define HOSAL_GPIO_PIN_INT_EDGE_FALLING GPIO_PIN_INT_EDGE_FALLING   /*!< GPIO Interrupt enable for Falling Edge */
#define HOSAL_GPIO_PIN_INT_BOTH_EDGE    GPIO_PIN_INT_BOTH_EDGE      /*!< GPIO Interrupt enable for both Rising and Falling Edge */
