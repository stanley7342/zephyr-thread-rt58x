...
typedef struct reg_rf_mcu_ahb_intr_enable_s
{
    ...
    uint32_t volatile COMM_RTC_SLOW_AON : 1;
    uint32_t volatile _RSVD_2_          : 6;
    uint32_t volatile HOST_BUSY         : 1;
    uint32_t volatile _RSVD_3_          : 7;
...
typedef struct reg_rf_mcu_ahb_intr_status_s
{
    ...
    uint32_t volatile _RSVD_            : 7;
    uint32_t volatile DMA_IS_BUSY          : 1;
