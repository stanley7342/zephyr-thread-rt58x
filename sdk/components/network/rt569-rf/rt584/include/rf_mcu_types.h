...
typedef struct rf_mcu_system_config_s
{
    COMM_SUBSYSTEM_ISR_t  rf_mcu_isr;           /**< user application ISR handler. */
} RF_MCU_SYSTEM_CONFIG_t, *RF_MCU_SYSTEM_CONFIG_PTR_t;
