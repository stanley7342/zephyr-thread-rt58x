/*
 * rt582_compat.c — Thin Zephyr wrappers for pre-built library compatibility
 *
 * The pre-built .a libraries (librt582_driver.a, librt582_system.a, and the
 ...
 * librt582_driver.a references these for optional RF power-compensation     *
