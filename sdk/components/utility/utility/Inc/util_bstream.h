...
/**
* @defgroup BSTREAM BSTREAM API Definition
* Define BSTREAM definitions, structures, and functions.
* @ingroup Utility
* @{
*/
#ifndef BSTREAM_H
 ...
 * @return uint64_t Resulting BDA64 number.
 */
 ...
 *
 * @param p Bstream pointer.
 * @return uint64_t uint64_t Resulting BDA64 number.
 */
